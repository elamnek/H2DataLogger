...
char m_log_name_1[] = "data.log"; //no more than 8 chars in name

String log_sub_state(subSystemState_t* state, int8_t logFlags) {
    String dataString = "{";
    ...
    //do the actual write
    File dataFile = SD.open(m_log_name_1, FILE_WRITE);
